...
<div class="grid g4 mb">
  ...
  <a class="card qa" href="admin_settings.php"><div class="qa-ic"><?=icon('settings')?></div><div><strong>Settings</strong><small>Site name &amp; support contact</small></div></a>
  <a class="card qa" href="admin_email.php"><div class="qa-ic"><?=icon('mail')?></div><div><strong>Email Config</strong><small>SMTP &amp; test send</small></div></a>
</div>
